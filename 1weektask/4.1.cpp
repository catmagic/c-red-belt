...
public:
  explicit Logger(ostream& output_stream) : os(output_stream) {
    ...
    void SetLogLine(int value){line_number=value;;}
    void SetLogFile(const char* value){file_name=value;}
...
#define LOG(logger, message) logger.SetLogLine(__LINE__);logger.SetLogFile(__FILE__);logger.Log(message);
