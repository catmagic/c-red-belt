...
#define LOG(logger, message)  {ostringstream os;if(logger.GetLogFile()){if(logger.GetLogLine()){os<<__FILE__<<":"<<__LINE__<<" ";}else{os<<__FILE__<<" ";}}else{if(logger.GetLogLine()){os<<"Line "<<__LINE__<<" ";}};os<<message;logger.Log(os.str());}
